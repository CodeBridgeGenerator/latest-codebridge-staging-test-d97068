  ...
  const copyPageLink = () => {
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">Superior</label>
                    {superior.map((elem) => (
...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">Subordinate</label>
