...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">Image</label><p><img id="image" src={_entity?.image} className="m-0 ml-3" width={300}  /></p></div>
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">Bio</label><p className="m-0 ml-3" >{_entity?.bio}</p></div>
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">Head of Department</label><p className="m-0" ><i id="hod" className={`pi ${_entity?.hod?"pi-check": "pi-times"}`}  ></i></p></div>
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">Head of Section</label><p className="m-0" ><i id="hos" className={`pi ${_entity?.hos?"pi-check": "pi-times"}`}  ></i></p></div>
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">Skills</label><p className="m-0 ml-3" ><Chip id="skills" label={_entity?.skills} /></p></div>
...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">Department</label>
                    {department.map((elem) => (
...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">Section</label>
                    {section.map((elem) => (
...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">Position</label>
                    {position.map((elem) => (
...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">Manager</label>
                    {manager.map((elem) => (
                        <Link key={elem._id} to={`/users/${elem._id}`}>
                        <div>
                  {" "}
...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">Company</label>
                    {company.map((elem) => (
...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">Address</label>
                    {address.map((elem) => (
...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">Phone</label>
                    {phone.map((elem) => (
