...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">Company no</label><p className="m-0 ml-3" >{_entity?.companyNo}</p></div>
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">New company number</label><p className="m-0 ml-3" >{Number(_entity?.newCompanyNumber)}</p></div>
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">Date Incorporated</label><p id="DateIncorporated" className="m-0 ml-3" >{_entity?.DateIncorporated}</p></div>
